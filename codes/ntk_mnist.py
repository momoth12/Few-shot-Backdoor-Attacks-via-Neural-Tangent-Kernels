...
data_train=datasets.load_mnist_dataset()
data_test=datasets.load_mnist_dataset(train=False)
...
poison_mnist_train = datasets.PoisonedDataset(
    subset_train,
    poisoner,
    # eps=eps,
    eps=None,
    label=clean_label,
    transform=datasets.MNIST_TRANSFORM_TEST_XY,
)
# print(poison_mnist_train.indices)
mnist_test = datasets.MappedDataset(subset_test, datasets.MNIST_TRANSFORM_TEST_XY)

poison_mnist_test = datasets.PoisonedDataset(
    subset_test,
    poisoner,
    # eps=1000,
    eps=None,
